...
typedef PolicyPresentationChanged(String? value);
...
class PolicyPresentationDropdownButtonWidget extends StatefulWidget {
  ...
  PolicyPresentationDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
