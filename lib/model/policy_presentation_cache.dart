...
class PolicyPresentationCache implements PolicyPresentationRepository {
  ...
  final Map<String, PolicyPresentationModel> fullCache = Map();
  ...
  Future<PolicyPresentationModel> get(String id, {Function(Exception) onError}) {
    PolicyPresentationModel value = fullCache[id];
  ...
  @override
  StreamSubscription<List<PolicyPresentationModel>> listen(trigger, {String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<List<PolicyPresentationModel>> listenWithDetails(trigger, {String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
    return reference.listenWithDetails(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<PolicyPresentationModel> listenTo(String documentId, changed) {
