...
class PolicyPresentationListWidget extends StatefulWidget with HasFab {
  ...
  PolicyPresentationListWidget({ Key key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
class PolicyPresentationListWidgetState extends State<PolicyPresentationListWidget> {
  ...
  Widget fab(BuildContext aContext, AccessState accessState) {
    if (accessState is AppLoaded) {
      return !accessState.memberIsOwner() 
        ...
        heroTag: "PolicyPresentationFloatBtnTag",
  ...
  Widget getForm(value, action) {
    if (widget.form == null) {
      return PolicyPresentationForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: ListTile(
        onTap: onTap,
        title: Hero(
          tag: '${value.documentID}__PolicyPresentationheroTag',
          child: Container(
