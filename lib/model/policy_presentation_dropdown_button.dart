...
typedef PolicyPresentationChanged(String? value, int? privilegeLevel,);
...
class PolicyPresentationDropdownButtonWidget extends StatefulWidget {
  ...
  PolicyPresentationDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PolicyPresentationDropdownButtonWidgetState();
  }
}

class PolicyPresentationDropdownButtonWidgetState extends State<PolicyPresentationDropdownButtonWidget> {
  PolicyPresentationListBloc? bloc;

  PolicyPresentationDropdownButtonWidgetState();
...
List<Widget> widgets(PolicyPresentationModel value) {
var app = widget.app;
var widgets = <Widget>[];
...
return widgets;
        ...
        return ListView(
          ...
          Row(children: [(false)
            ? Container(
                ...
                child: dropdownButton<String>(
                      ...
                      items: items,
                      value: widget.value,
                      hint: text(widget.app, context, 'Select a policyPresentation'),
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'policyPresentations', widget.value, (newValue, _) {
                  setState(() {
  ...
  void _onPrivilegeLevelChange(int? value) {
    BlocProvider.of<PolicyPresentationListBloc>(context).add(PolicyPresentationChangeQuery(
