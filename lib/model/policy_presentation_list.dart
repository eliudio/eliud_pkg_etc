...
typedef PolicyPresentationWidgetProvider(PolicyPresentationModel? value);

class PolicyPresentationListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  PolicyPresentationWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  PolicyPresentationListWidgetState? state;
  bool? isEmbedded;

  PolicyPresentationListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  PolicyPresentationListWidgetState createState() {
    state ??= PolicyPresentationListWidgetState();
    return state!;
  }
...
class PolicyPresentationListWidgetState extends State<PolicyPresentationListWidget> {
  @override
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              value: BlocProvider.of<PolicyPresentationListBloc>(context),
              child: PolicyPresentationForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return PolicyPresentationListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return PolicyPresentationForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
