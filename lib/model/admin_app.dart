...
class AdminApp extends AdminAppInstallerBase {
  ...
  PageModel _policyPresentationsPages() {
    ...
    components.add(BodyComponentModel(
        documentID: "internalWidget-policyPresentations",
        componentName: "eliud_pkg_etc_internalWidgets",
        componentId: "policyPresentations"));
...
class AdminMenu extends AdminAppMenuInstallerBase {
  ...
  Future<MenuDefModel> menu(AppModel app) async {
    ...
    menuItems.add(MenuItemModel(
        ...
        action:
            GotoPage(app, pageID: "eliud_pkg_etc_policypresentations_page")));

    MenuDefModel menu = MenuDefModel(
        admin: true,
        documentID: "eliud_pkg_etc_admin_menu",
