...
class DecoratedAppBarWidget extends StatefulWidget {
  ...
  DecoratedAppBarWidget({
    Key? key, required this.label, required this.isCreationMode, required this.appBarKey, required this.model, required this.createOriginalAppBar,
  }) : super(key: key);
...
class _DecoratedAppBarWidgetState extends State<DecoratedAppBarWidget> {
  ...
  MenuItemModel getMenuItemModelLocked() {
    return MenuItemModel(
        ...
        description: '',
        icon: IconModel(
            codePoint: Icons.lock.codePoint,
  ...
  MenuItemModel getMenuItemModelUnlocked() {
    return MenuItemModel(
        ...
        description: '',
        icon:IconModel(
            codePoint: Icons.lock_open.codePoint,
            fontFamily: Icons.lock_open.fontFamily),
        action: FunctionToRun(widget.model.appId, actionToRun: () {
          setState(() {
